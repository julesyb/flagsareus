...
const es: DeepPartial<TranslationStrings> = {
  ...
  onboarding: {
    ...
    skillBeginner: 'No soy muy bueno con banderas',
  ...
  challenge: {
    ...
    responseShareCard: '{name} obtuvo {correct}/{total} en tu desafio de Flag That!\n\n{link}',
    responseReceived: 'Resultados recibidos!',
    responseReceivedDesc: '{name} obtuvo {score}/{total} en tu desafio',
    responseNotFound: 'No se encontro el desafio correspondiente',
