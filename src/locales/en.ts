const en = {
  ...
  home: {
    ...
    geoFacts: 'GeoFacts',
    geoFactsDesc: 'Browse facts or test yourself',
    mapMode: 'Map Mode',
  ...
  setup: {
    ...
    geoFacts: 'GeoFacts',
    geoFactsDesc: 'Browse facts or quiz yourself',
  ...
  geofacts: {
    title: 'GeoFacts',
    subtitle: 'Flag and country facts',
    browse: 'Browse',
    quiz: 'Quiz',
    quizIntro: 'Answer {count} questions drawn from hundreds of flag and country facts.',
    startQuiz: 'Start quiz',
    next: 'Next',
  ...
  onboarding: {
    ...
    playCta: 'Play',
    playCtaSub: "Jump right in, we'll start you easy",
    orPickLevel: 'Or pick your own level',
