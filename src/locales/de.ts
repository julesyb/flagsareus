...
const de: typeof en = {
  ...
  setup: {
    ...
    flagFlash: 'FlagFlash',
    flagFlashDesc: 'Partymodus, kippen zum Spielen',
  ...
  challenge: {
    ...
    shareMessage: 'Ich fordere dich heraus, meinen Score bei Flag That zu schlagen! F\u00fcge diesen Code im Bereich Herausforderung ein:',
